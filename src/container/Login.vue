...
<div id="content" class="content" style="min-height: 370px;">
        <form id="mainForm" class="main-form" enctype="application/x-www-form-urlencoded" novalidate="novalidate">
            <div class="tab-title">
                <a class="linkABlack" id="toAccountLogin" href="javascript:void(0);">账号登录</a>
            ...
            <div class="normalInput" style="margin-bottom: 20px;">
                <input v-model="username" class="pl_5 inp-focus" type="text" value="" placeholder="手机号/ Flyme 账号" name="account" id="account" maxlength="50" autocomplete="off"><span class="inputTip"></span>
            </div>
            <div class="normalInput">
                <input v-model="password" class="pl_5 inp-focus" type="password" placeholder="密码" name="password" id="password" maxlength="16" value="" autocomplete="off"><span class="inputTip"></span>
                <div class="clear"></div>
            </div>
            <div class="rememberField"><span class="mzchkbox"><span class="checkboxPic check_unchk"><i class="i_icon"></i></span><input name="remember" id="remember" type="checkbox" value="1" style="display: none;"></span><label for="remember" tabindex="0">记住登录状态</label><a id="forgetpwd" href="/" class="linkABlue">忘记密码?</a></div>
            <a id="login" class="fullBtnBlue login-btn" v-on:click="login">登录</a>
            <a id="new_a_mregister" class="btn-go2register" href="/">注册</a>
        </form>
    </div>
</template>
...
.footer-language_menu a.ClobalItem:link {
    color: #000000;
}

.footer-language_menu a.ClobalItem:visited {
    color: #000000;
}

.footer-language_menu a.ClobalItem:hover {
    color: #515151;
}

.footer-language_menu a.checked,
.footer-language_menu a.checked:hover {
    color: #1daeed;
    text-decoration: none;
}
...
.btnOnOff2 {
    ...
    margin: 0px auto;
    overflow: hidden;
    background: url(/resources/uc/wlogin/base/images/elements.png) no-repeat 0px -24px;
}
...
#blockUICenter {
    position: absolute;
    background: url(/resources/common/images/default/processing-80.gif) 0 0 no-repeat;
    color: #FAFAFA;
    margin: 0px auto;
    width: 315px;
    height: 30px;
...
DIV.ZZtips .content {
    float: left;
    BACKGROUND: url(/resources/common/images/default/zztip_2_middle.gif) 0px 0px repeat-x;
    width: 15px;
    height: 46px;
}

DIV.ZZtips .content-left {
    float: left;
    BACKGROUND: url(/resources/common/images/default/zztips_2.gif) 0px 0px no-repeat;
    width: 40px;
    height: 46px;
}

DIV.ZZtips .content-right {
    float: left;
    BACKGROUND: url(/resources/common/images/default/zztips_2.gif) -40px 0px no-repeat;
    width: 15px;
    height: 46px;
}
...
DIV.MANItips .tipstyle {
    BORDER-BOTTOM: #d5a337 2px solid;
    BORDER-LEFT: #d5a337 1px solid;
    LINE-HEIGHT: 16px;
    BACKGROUND: #ffffff;
    FONT-SIZE: 12px;
    BORDER-TOP: #d5a337 1px solid;
    BORDER-RIGHT: #d5a337 2px solid;
    POSITION: RELATIVE;
}

DIV.MANItips .tipstyle A {
    COLOR: #6699cc
}

DIV.MANItips .tip_down {
    MARGIN-TOP: -3px;
    BACKGROUND: url(/resources/common/images/default/tip_down.gif) no-repeat 20% bottom;
    HEIGHT: 16px
}
...
@media (max-width:320px) {
    ...
    /*a.fullBtnBlue,.normalInput,.rememberField{width: 20rem;padding: 0}*/
    a.fullBtnBlue {
...
/* #getKey,a.linkABlue:link, a.linkABlue:visited{color:#1788e8;} */
...
.abnormal-tips {
    color:#32A5E7;font-size:12px;padding:5px 0;cursor: pointer;margin:-10px 0 10px;
}
...
.tip-font{overflow: visible;color: #666;font-size: 12px;padding-right: 25px;padding-left: 35px;display: table-cell;vertical-align: middle;}
/*.err-ico{background:url('../images/error-ico.png');width: 16px;height: 16px;display: inline-block;position: absolute;top: 8px;left: 10px;}*/
/*.close-ico{background:url('../images/close-ico.png');background-repeat: no-repeat;cursor: pointer;width: 16px;height: 16px;display: inline-block;position: absolute;top: 8px;right: 10px;}*/
.btn-error{border: 1px solid red;}
.btn-focus{border:1px solid #198DED;}
.visiblility-hidden{visibility: hidden;}
.tab-title{position:relative;}
.tab-title .linkABlack{position: absolute;right: 50%;margin-right: 25px;}
.tab-title .linkAGray{position: absolute;left: 50%;margin-left: 25px;}
.hide{display:none !important}
.btn-wrap .btn-blue{border: solid 1px #198DED;}
